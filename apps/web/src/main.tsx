...
if('serviceWorker' in navigator&&(location.hostname==='localhost'||location.protocol==='https:'))void navigator.serviceWorker.register('/sw.js').catch(()=>{/* LAN HTTP cannot install an offline shell. Durable records remain in IndexedDB. */});
